...
<html>
    <head>
      <meta charset="utf-8">
      <title>Lauren Chu's Profile</title>
      <link rel="stylesheet" href="css/chustyle.css">
    </head>

    <body>
        <nav>
            <a href="L.ChuStudyAbroad.html">Travel Blog</a>
        </nav>
        <h1>Lauren M. Chu</h1>
        <h2>Accounting Information Systems major at Fordham University</h2>
